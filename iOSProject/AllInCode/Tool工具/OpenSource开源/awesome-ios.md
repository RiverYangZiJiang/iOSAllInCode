...
The list is divided into categories such as Frameworks, Components, Testing and others, open source projects, free and paid services. There is no pre-established order of items in each category, the order is for contribution每个分类下的各项，并没有预先建立的顺序，是按照贡献的顺序. If you want to contribute, please read the [guide](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md)如果你想贡献，请阅读指南.
...
- Simply press <kbd>command</kbd> + <kbd>F</kbd> to search for a keyword简单地按下comma+f来搜索关键字
- Go through our *Content Menu*浏览我们的内容菜单

### Content内容
- [About](#about)
- [How to Use](#how-to-use)
- [Courses](#courses)课程【官方、大学、培训机构】
- [Accessibility](#accessibility)辅助功能【使得残疾人也能使用你的App】
- [Alexa](#alexa)【自定义亚马逊alexa技能的框架，Alexa为亚马逊最完善的智能家居生态系统】
- [Analytics](#analytics)*分析平台，SDK，错误跟踪和有关您的应用的实时答案*
- [App Routing](#app-routing)应用路由，*优雅的URL路由，导航框架，深层链接等*
- [Apple TV](#apple-tv)
- [Architecture Patterns](#architecture-patterns)Clean architecture, Viper, MVVM, Reactive... choose your weapon.
- [ARKit](#arkit)
- [Authentication](#authentication)*Oauth和Oauth2库，社交登录和验证码工具。*
- [Blockchain](#blockchain)区块链
- [Bridging](#bridging)桥接，*在Objective-C和Swift，iOS和macOS，Javascript和Objective-C之间共享代码。*
- [Cache](#cache)缓存，*线程安全，离线和高性能缓存库和框架。*
- [Charts](#charts)图标
- [Code Quality](#code-quality)代码质量，*质量总是很重要。代码检查器，内存警惕，合成糖等。*【MLeaksFinder，Find memory leaks in your iOS app at develop time.】
    - [Linter](#linter)
- [Color](#color)颜色，*十六进制颜色扩展，主题，颜色选择器和其他令人敬畏的颜色工具。*
- [Command Line](#command-line)命令行，*智能，美观，优雅的工具，可帮助您创建命令行应用程序。*
- [Concurrency](#concurrency)并发，*Job schedulers, Coroutines, Asynchronous and Type safe threads libs and frameworks written in Swift*
- [Core Data](#core-data)
- [Database](#database)【Realm，CoreData和SQLite的替代品：简单，现代和快速。】
- [Data Structures / Algorithms](#data-structures--algorithms)数据结构/算法，*Diffs，keypaths，排序列表和其他令人惊叹的数据结构包装器和库。*
- [Date & Time](#date--time)日期&时间，时间和日历库。并且包括日出和日落时间生成器、时间选择器和NSTimer接口。
- [Debugging](#debugging)调试，调试工具，崩溃报告，日志和控制台UI。*【Woodpecker，查看来自Mac的沙箱文件，UserDefaults，网络请求。】
- [EventBus](#eventbus)时间总线，*Promise和Futures库可以帮助您在Swift中编写更好的异步代码。*
- [Files](#files)*File management, file browser, zip handling and file observers.*【[FileExplorer](https://github.com/Augustyniak/FileExplorer)，适用于iOS的强大文件浏览器，允许用户选择和删除文件和/或目录。】
- [Functional Programming](#functional-programming)*Collection of Swift functional programming tools.*
- [Games](#games)
- [GCD](#gcd)*Grand Central Dispatch syntax sugars, tools and timers.*
- [Gesture](#gesture)*Libraries and tools to handle gestures.*【[FDFullscreenPopGesture](https://github.com/forkingdog/FDFullscreenPopGesture)全屏右滑返回】
- [Graphics](#graphics)图像，*CoreGraphics，CoreAnimation，SVG，CGContext库，帮助器和工具。*
- [Hardware](#hardware)硬件
    - [Bluetooth](#bluetooth)蓝牙
    - [Camera](#camera)相机
    - [Force Touch](#force-touch)轻按App图标弹出的Quick actions
    - [iBeacon](#ibeacon)室内蓝牙定位
    - [Location](#location)位置【[set-simulator-location](https://github.com/lyft/set-simulator-location)，用于在iOS模拟器中设置位置的CLI。】
    - [Other Hardware](#other-hardware)
- [Layout](#layout)布局
- [Logging](#logging)日志，*Debugging tools, crash reports, logs and console UI's.*
- [Localization](#localization)本土化
...
- [Media](#media)多媒体
    ...
    - [Streaming](#streaming)
    - [Video](#video)
- [Messaging](#messaging)消息【[Messenger Chat with Firebase](https://github.com/instamobile/messenger-iOS-chat-swift-firestore)，Swift messaging chat app with Firebase Firestore integration.】
...
- [Objective-C Runtime](#objective-c-runtime)运行时
- [Optimization](#optimization)优化，
- [Parsing](#parsing)解析
    - [CSV](#csv)
    - [JSON](#json)【[YYModel](https://github.com/ibireme/YYModel) 】
    - [XML & HTML](#xml--html)
    - [Other Parsing](#other-parsing)
- [Passbook](#passbook)存折
- [Payments](#payments)支付
- [Permissions](#permissions)权限【[Proposer](https://github.com/nixzhu/Proposer)一行代码搞定相机、相册、麦克风、联系人、位置的权限申请，swift语言】
- [Products](#products)产品
- [Reactive Programming](#reactive-programming)反应式编程
    - [React-Like](#react-like)
- [Reflection](#reflection)反射
- [Regex](#regex)正则表达式
- [SDK](#sdk)
    - [Official](#official)官方SDK
    - [Unofficial](#unofficial)非官方SDK
...
- [Testing](#testing)测试
    - [TDD / BDD](#tdd--bdd)
    - [A/B Testing](#ab-testing)A/B测试
    - [UI Testing](#ui-testing)UI测试
    - [Other Testing](#other-testing)
- [Text](#text)文本
    - [Font](#font)字体
- [UI](#ui)
    - [Activity Indicator](#activity-indicator)活动指标
    - [Alert & Action Sheet](#alert--action-sheet)警报和行动表
    ...
    - [Cards](#cards)卡片
    - [Form & Settings](#form—settings)表单与设置
    - [Keyboard](#keyboard)键盘【IQKeyboardManager，无代码插入式通用库允许防止键盘滑动问题并覆盖UITextField / UITextView。】
    - [Label](#label)【[MZTimerLabel](https://github.com/mineschan/MZTimerLabel) ，倒计时或者秒表】
    - [Login](#login)登录
    - [Menu](#menu)菜单
    - [Navigation Bar](#navigation-bar)导航条
    - [PickerView](#pickerview)选择视图，如选择日期、国家
    - [Popup](#popup)弹出的对话框
    - [Pull to Refresh](#pull-to-refresh)下拉刷新
    - [Rating Stars](#rating-stars)评星级
    - [ScrollView](#scrollview)滚动视图
    - [Segmented Control](#segmented-control)分段控制
    - [Slider](#slider)滑块
    - [Splash View](#splash-view)飞溅视图，Twitter、Uber的自定义动画启动视图。
    - [Status Bar](#status-bar)状态栏
    - [Stepper](#stepper)
    - [Switch](#switch)开关
    - [Tab Bar](#tab-bar)标签栏
    - [Table View / Collection View](#table-view--collection-view)表视图/集合视图
      - [Table View](#table-view)表视图
      - [Collection View](#collection-view)集合视图
      - [Expandable Cell](#expandable-cell)可扩展单元格
      - [Header](#header)头
      - [Placeholder](#placeholder)占位符【DZNEmptyDataSet，showing empty datasets whenever the view has no content to display】
      - [Collection View Layout](#collection-view-layout)集合视图布局
    - [Tag](#tag)标签
    - [TextField & TextView](#textfield--textview)
    - [UIPageControl](#uipagecontrol)
    - [Web View](#web-view)
- [Utility](#utility)效用【BlocksKit】
- [User Consent](#user-consent)用户同意
- [VR](#vr)
- [Walkthrough / Intro / Tutorial](#walkthrough--intro--tutorial)
- [Websocket](#websocket)
- [Project setup](#project-setup)项目设置
- [Dependency / Package Manager](#dependency--package-manager)依赖/包管理器，如CocoaPods
- [Tools](#tools)
- [Rapid Development](#rapid-development)快速开发
  - [Injection](#injection)注入
- [Deployment / Distribution](#deployment--distribution)部署/分发
- [App Store](#app-store)
- [Xcode](#xcode)
    - [Extensions (Xcode 8+)](#extensions-xcode-8)扩展
    - [Themes](#themes)主题
    - [Other Xcode](#other-xcode)
- [Reference](#reference)参考【**Objective-C-CheatSheet**，OC的高级主题】
- [Style Guides](#style-guides)编码风格指南
- [Good Websites](#good-websites)好的网站
    - [News, Blogs and more](#news-blogs-and-more)新闻，博客等
...
### UIKit references
* [iOS Fonts](http://iosfonts.com/)iOS字体
* [UIAppearance list](https://gist.github.com/mattt/5135521)UIAppearance列表

### Forums and discuss lists论坛和讨论列表
* ["iOS" on Stackoverflow](https://stackoverflow.com/questions/tagged/ios)

### Tutorials and Keynotes教程和主题演讲
...
### iOS UI Template iOS UI模板
* [iOS UI Design Kit](https://www.invisionapp.com/inside-design/design-resources/tethr/) 设计套件
* [iOS Design Guidelines](https://ivomynttinen.com/blog/ios-design-guidelines) 设计指南
...
* [iOS Learning Resources](https://github.com/sanketfirodiya/iOS-learning-resources) Comprehensive collection of high quality, frequently updated and well maintained iOS tutorial sites.全面收集高质量，经常更新和维护良好的iOS教程网站。
...
* [awesome-ios-ui](https://github.com/cjwirth/awesome-ios-ui) - A curated list of awesome iOS UI/UX libraries.精选iOS UI / UX库的精选列表。
...
* [awesome-interview-questions](https://github.com/MaximAbramchuck/awesome-interview-questions#ios) - A curated awesome list of lists of interview questions including iOS.一系列精选的面试问题列表，包括iOS。
* [iOS-Playbook](https://github.com/bakkenbaeck/iOS-handbook) - Guidelines and best practices for excellent iOS apps
* [iOS-Learning-Materials](https://github.com/jVirus/iOS-Learning-Materials) - Curated list of articles, web-resources, tutorials and code repositories that may help you dig a little bit deeper into iOS.精选的文章，网络资源，教程和代码存储库列表，可帮助您深入了解iOS。
* [Awesome-iOS-Twitter](https://github.com/carolanitz/Awesome-iOS-Twitter) - A curated list of awesome iOS Twitter accounts精选的iOS Twitter帐户的精选列表
...
* [Awesome iOS Interview question list](https://github.com/dashvlas/awesome-ios-interview) - Guide for interviewers and interviewees. Review these iOS interview questions - and get some practical tips along the way.面试官和受访者指南。回顾这些iOS面试问题 - 并在此过程中获得一些实用技巧。
* [Top App Developers](https://github.com/app-developers/top) - A list of top iOS app developers顶级iOS应用开发者列表
